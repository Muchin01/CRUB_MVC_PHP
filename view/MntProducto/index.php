...
<div class="wrapper">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="../../resource/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      <img src="../../resource/dist/img/AdminLTELogo.png"
           ...
           style="opacity: .8">
      <span class="brand-text font-weight-light">CodeByte</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Marlon Muchin</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              ...
              <!-- <i class="nav-icon fas fa-solid fa-window-minimize"></i> -->
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <i class="nav-icon fas fa-thin fa-angle-right"></i>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022 .</strong> Marlon Muchin
    reserved.
  </footer>
